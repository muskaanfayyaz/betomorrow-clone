...
export default function GenAIWorkshop() {
  return (
    <section className="bg-gradient-to-br from-blue-200 to-white w-full pt-[6rem] md:pt-[8rem]">
      <div className="max-w-[100rem] mx-auto 3xl:max-w-[1600px] pl:2 small:pl-3 ">
        
        {/* Top Section */}
        <div className="flex flex-col gap-10 xl:gap-20 3xl:gap-24 xl:grid xl:grid-cols-[40%_60%] xl:items-start">

          {/* Left Image */}
          <div className="flex items-end">
            <div className="relative w-full h-[24rem] small:h-[32rem] md:h-[42rem] lg:h-[44rem] xl:h-[49rem] 3xl:w-[90%] 3xl:h-[52rem] rounded-3xl overflow-hidden">
              <Image
          ...
          {/* Right Content */}
          <div className="flex flex-col justify-between text-[#1a1a1a] 3xl:pl-12">
